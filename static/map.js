...
// For use within CyberPot:
//   - Access AttackMap via CyberPot's WebUI (https://<your CyberPot IP>:64297/map/)
...
function connectWebSocket() {
  ...
  webSock.onopen = function () {
    // Log connection success and display "CyberPot Honeypot Stats" title in green, so we know connection is established
    var honeypotStatsHeader = document.getElementById("honeypotStatsHeader");
    honeypotStatsHeader.style.color = "green";
    honeypotStatsHeader.textContent = "CyberPot Honeypot Stats"
  ...
  webSock.onclose = function (event) {
     ...
     // Log error and display "CyberPot Honeypot Stats" title in red, so we know connection is interrupted
